...
/**
 * This is leve1state and is the core setup of our game.
...
public class Level1State extends GameState {
    ...
    public Level1State(GameStateManager gm) {
        this.gm = gm;
        initMap();
        initPlayers();
    }
        ...
        if (key == KeyEvent.VK_E) {
            for (Door door : doors) {
                if (player.checkDoor(door)) {
                    ...
                    if (door.hasBonus() && door.getDoorID() == 3) {
                        BonusReward bonusReward = new BonusReward(map, BONUS_REWARD_VALUE);
                        bonusReward.setX(1120);
                        bonusReward.setY(1100);
                        bonusRewards.add(bonusReward);
                    }
    ...
    private void initMap() {
        map = new Map("src/main/resources/level2.txt", 64);
        ...
        door3.setY(1134);
        door3.setTrap(false);
        door3.setbonusReward(true);
        doors.add(door3);

        Door door4 = new Door(map, 4);
        door4.setX(1054);
        door4.setY(774);
        door4.setTrap(true);
        door4.setbonusReward(false);
        doors.add(door4);
        ...
        Trap trap5 = new Trap(map, TRAP_VALUE);
        trap5.setX(750);
        trap5.setY(1102);
        traps.add(trap5);

        Trap trap6 = new Trap(map, TRAP_VALUE);
        trap6.setX(90);
        trap6.setY(608);
        traps.add(trap6);
